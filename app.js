...
const categorias = {
  ...
  "Linha Premium 200ml (12 un)": [
    { nome: "Molho Habanero com Ervas Picante", unidades: 12, custo_caixa: 63.60 }
  ],
  "Temperos 450g (12 un)": [
...
function atualizarCustos() {
  ...
  document.getElementById("custoUnitario").textContent = (produto.custo_caixa / produto.unidades).toFixed(2);
}
