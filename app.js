...
Object.keys(categorias).forEach(cat => {
  ...
  // listar produtos na aba Produtos
...
function gerarPDF() {
  ...
  y += 6;
  doc.text(`Total: R$ ${document.getElementById("totalPedido").textContent}`, 10, y);
  doc.text(`Lucro: R$ ${document.getElementById("lucroPedido").textContent}`, 10, y + 6);
